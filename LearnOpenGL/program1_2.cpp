...
GLuint createShaderProgram() {
	...
	const char* fshaderSource = "#version 430 \n"
		"out vec4 color; \n"
		"void main(void) \n"
		"{ if(gl_FragCoord.x < 200) color = vec4(1.0, 0.0, 0.0, 1.0); else color = vec4(1.0,0.0,1.0,1.0);}";
...
int main2()
{
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "Jinwei's 2nd OpenGL Application", NULL, NULL);
